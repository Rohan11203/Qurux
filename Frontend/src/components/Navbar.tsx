  ...
  return (
    ...
    className="bg-white  w-full max-w-xs sm:max-w-sm md:max-w-2xl lg:max-w-4xl xl:max-w-6xl mx-auto rounded-3xl p-4 sm:p-6 md:p-6">
      <div className='flex justify-between '>
        <div className='flex gap-2 items-center text-2xl font-semibold'><span><Circle fill='#fbd1d0' height={50} width={35}/></span>QurRux</div>
        <div className='flex gap-4 cursor-pointer text-lg items-center font-medium font-serif'>
            ...
            <div className='text-[#fbd1d0]'>Home</div>
            <div>About</div>
            <div>Service</div>
            <div>Procedures</div>
            <div>Pages +</div>
